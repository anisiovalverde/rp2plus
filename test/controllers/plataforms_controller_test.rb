...
class PlataformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plataform" do
    assert_difference("Plataform.count") do
      post plataforms_url, params: { plataform: { active: @plataform.active, name: @plataform.name } }
    end
  ...
  test "should update plataform" do
    patch plataform_url(@plataform), params: { plataform: { active: @plataform.active, name: @plataform.name } }

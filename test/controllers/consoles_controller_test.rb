...
class ConsolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create console" do
    assert_difference("Console.count") do
      post consoles_url, params: { console: { active: @console.active, category: @console.category, link: @console.link, name: @console.name, price: @console.price, video: @console.video } }
    end
  ...
  test "should update console" do
    patch console_url(@console), params: { console: { active: @console.active, category: @console.category, link: @console.link, name: @console.name, price: @console.price, video: @console.video } }
